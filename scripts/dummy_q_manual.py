...
from src.models.od import yolo_v11_n, yolo_v11_s
...
from src.models.od import yolo_v11
...
composer.model.load_state_dict(torch.load("data/models/yolov11_n_best.pt")["model"].state_dict())
